...
const LOCATIONS = [
    ...
    // ═══ NOUVELLES DESTINATIONS (360° / Panoramas) ═══
    { lat: 27.1751, lng: 78.0421, name: "Taj Mahal", country: "Inde" },
    { lat: -13.1631, lng: -72.5450, name: "Machu Picchu", country: "Pérou" },
    { lat: 41.8902, lng: 12.4922, name: "Colisée", country: "Italie" },
    { lat: 36.0544, lng: -112.1401, name: "Grand Canyon", country: "États-Unis" },
    { lat: -22.9519, lng: -43.2104, name: "Christ Rédempteur", country: "Brésil" },
    { lat: 20.6843, lng: -88.5678, name: "Chichén Itzá", country: "Mexique" },
    { lat: 40.4319, lng: 116.5704, name: "Grande Muraille", country: "Chine" },
    { lat: 35.3606, lng: 138.7274, name: "Mont Fuji", country: "Japon" },
    { lat: 48.6361, lng: -1.5115, name: "Mont Saint-Michel", country: "France" },
    { lat: -25.3444, lng: 131.0369, name: "Uluru (Ayers Rock)", country: "Australie" },
    { lat: 13.4125, lng: 103.8670, name: "Angkor Wat", country: "Cambodge" },
    { lat: 37.9715, lng: 23.7267, name: "Acropole d'Athènes", country: "Grèce" },
    { lat: 31.2001, lng: 29.9187, name: "Bibliothèque d'Alexandrie", country: "Égypte" },
    { lat: 40.6892, lng: -74.0445, name: "Statue de la Liberté", country: "États-Unis" },
    { lat: 51.1789, lng: -1.8262, name: "Stonehenge", country: "Royaume-Uni" },
    { lat: 43.7229, lng: 10.3966, name: "Tour de Pise", country: "Italie" },
    { lat: 37.8201, lng: -122.4783, name: "Golden Gate Bridge", country: "États-Unis" },
    { lat: 64.1466, lng: -21.9426, name: "Reykjavik", country: "Islande" },
    { lat: 34.6937, lng: 135.5023, name: "Château d'Osaka", country: "Japon" },
    { lat: -0.0236, lng: 37.9062, name: "Mont Kenya", country: "Kenya" },
    { lat: 25.1972, lng: 55.2744, name: "Burj Khalifa", country: "Émirats arabes unis" }
];
